    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">
          Aao Ek Nayi Dunia Banaate Hain aur Duniya ko Dikhate hain.
        </p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 ">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Ek baar aapko aapke man ki image mil jaaye, to aap use logo ke sath
            community par share bhi kar skte hain.
          </p>
        </div>
        <button
          type="submit"
          className="mt-5 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full  px-5 py-2.5 text-center"
        >
